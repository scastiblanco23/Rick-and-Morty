export function CharacterCard(character) {
  ...
  return `
    <div class="character-card bg-slate-800 rounded-xl overflow-hidden w-72"data-id="${character.id}">
      ...
      <div class="p-4 text-white h-[130px]">
      ...
      <div class="flex gap-2 p-4 text-white">
          ...
          <button type="button" class="bg-blue-500 px-4 py-2 rounded-lg text-sm w-full" data-action="edit" data-id="${character.id}"> Editar </button>

          <button type="button" class="bg-red-500 px-4 py-2 rounded-lg text-sm w-full" data-action="delete" data-id="${character.id}"> Eliminar </button>
